...
@javax.annotation.Generated(
    ...
    comments = "Source: user_order.proto")
...
public final class OrderServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ru.itis.order.proto.OrderRequest,
      ru.itis.order.proto.OrderResponse> getGetOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetOrder",
      requestType = ru.itis.order.proto.OrderRequest.class,
      responseType = ru.itis.order.proto.OrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ru.itis.order.proto.OrderRequest,
      ru.itis.order.proto.OrderResponse> getGetOrderMethod() {
    io.grpc.MethodDescriptor<ru.itis.order.proto.OrderRequest, ru.itis.order.proto.OrderResponse> getGetOrderMethod;
    if ((getGetOrderMethod = OrderServiceGrpc.getGetOrderMethod) == null) {
      synchronized (OrderServiceGrpc.class) {
        if ((getGetOrderMethod = OrderServiceGrpc.getGetOrderMethod) == null) {
          OrderServiceGrpc.getGetOrderMethod = getGetOrderMethod =
              io.grpc.MethodDescriptor.<ru.itis.order.proto.OrderRequest, ru.itis.order.proto.OrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetOrder"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.itis.order.proto.OrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.itis.order.proto.OrderResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ru.itis.order.proto.CreateOrderRequest,
      ru.itis.order.proto.OrderResponse> getCreateOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateOrder",
      requestType = ru.itis.order.proto.CreateOrderRequest.class,
      responseType = ru.itis.order.proto.OrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ru.itis.order.proto.CreateOrderRequest,
      ru.itis.order.proto.OrderResponse> getCreateOrderMethod() {
    io.grpc.MethodDescriptor<ru.itis.order.proto.CreateOrderRequest, ru.itis.order.proto.OrderResponse> getCreateOrderMethod;
      ...
      synchronized (OrderServiceGrpc.class) {
        if ((getCreateOrderMethod = OrderServiceGrpc.getCreateOrderMethod) == null) {
          OrderServiceGrpc.getCreateOrderMethod = getCreateOrderMethod =
              io.grpc.MethodDescriptor.<ru.itis.order.proto.CreateOrderRequest, ru.itis.order.proto.OrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateOrder"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.itis.order.proto.CreateOrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ru.itis.order.proto.OrderResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getOrder(ru.itis.order.proto.OrderRequest request,
        io.grpc.stub.StreamObserver<ru.itis.order.proto.OrderResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetOrderMethod(), responseObserver);
    }

    /**
     */
    default void createOrder(ru.itis.order.proto.CreateOrderRequest request,
        io.grpc.stub.StreamObserver<ru.itis.order.proto.OrderResponse> responseObserver) {
  ...
  public static final class OrderServiceStub
    ...
    /**
     */
    public void getOrder(ru.itis.order.proto.OrderRequest request,
        io.grpc.stub.StreamObserver<ru.itis.order.proto.OrderResponse> responseObserver) {
    ...
    /**
     */
    public void createOrder(ru.itis.order.proto.CreateOrderRequest request,
        io.grpc.stub.StreamObserver<ru.itis.order.proto.OrderResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class OrderServiceBlockingV2Stub
    ...
    /**
     */
    public ru.itis.order.proto.OrderResponse getOrder(ru.itis.order.proto.OrderRequest request) {
    ...
    /**
     */
    public ru.itis.order.proto.OrderResponse createOrder(ru.itis.order.proto.CreateOrderRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class OrderServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ru.itis.order.proto.OrderResponse> getOrder(
        ru.itis.order.proto.OrderRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ru.itis.order.proto.OrderResponse> createOrder(
        ru.itis.order.proto.CreateOrderRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ORDER:
          serviceImpl.getOrder((ru.itis.order.proto.OrderRequest) request,
              (io.grpc.stub.StreamObserver<ru.itis.order.proto.OrderResponse>) responseObserver);
          break;
        case METHODID_CREATE_ORDER:
          serviceImpl.createOrder((ru.itis.order.proto.CreateOrderRequest) request,
              (io.grpc.stub.StreamObserver<ru.itis.order.proto.OrderResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ru.itis.order.proto.OrderRequest,
              ru.itis.order.proto.OrderResponse>(
                service, METHODID_GET_ORDER)))
        .addMethod(
          getCreateOrderMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ru.itis.order.proto.CreateOrderRequest,
              ru.itis.order.proto.OrderResponse>(
  ...
  private static abstract class OrderServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ru.itis.order.proto.UserOrder.getDescriptor();
    }
